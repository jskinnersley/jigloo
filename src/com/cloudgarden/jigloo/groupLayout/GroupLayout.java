...
public class GroupLayout implements LayoutManager2 {
    ...
    /**
     * Returns whether or not the specified Component should be visible.
     */
    ...
    private void dump(StringBuffer buffer, Spring spring, String indent,
        ...
        if (spring instanceof ComponentSpring) {
            ...
            if (name != null) {
            	...
            	origin += cSpring.getComponent().hashCode();
            }
        }
    ...
    private void prepare() {
        ...
        if (springsChanged || hasVisibilityChanged()) {
            checkComponents();
...
//            assert false;
    ...
    public class SequentialGroup extends Group {
        ...
        /*
        //===================================
        // methods for Java 6 compatibility
        ...
        public SequentialGroup addComponent(Component component, int min,
                int pref, int max) {
            return add(component, min, pref, max);
        }
        public SequentialGroup addComponent(boolean useAsBaseline,
...
//            assert delta != 0;
        ...
        void insertAutopadding(int axis, List leadingPadding,
            ...
            for (int counter = 0; counter < springs.size(); counter++) {
                ...
                if (spring instanceof AutopaddingSpring) {
                    ...
                    if (spring instanceof ComponentSpring) {
                        ComponentSpring cSpring = (ComponentSpring)spring;
                        if (!isVisible(cSpring.getComponent())) {
                            continue;
                        }
    ...
    public class ParallelGroup extends Group {
        ...
        /*
        //====================================================
        //methods for Java6 compatibility
        ...
        public ParallelGroup addGroup(Alignment alignment, Group group) {
            return add(alignment.getVal(), group);
        }
        public ParallelGroup addComponent(Component component,
                Alignment alignment) {
            return add(alignment.getVal(), component, DEFAULT_SIZE, DEFAULT_SIZE,
                    DEFAULT_SIZE);
        }
        public ParallelGroup addComponent(Component component,
                Alignment alignment, int min, int pref, int max) {
            return add(alignment.getVal(), component, min, pref, max);
        }
        //====================================================
        */
        boolean isResizable() {
     ...
     */
    public class ComponentSpring extends Spring {
...
//            assert (max == DEFAULT_SIZE);
        ...
        void installIfNecessary(int axis) {
            if (!installed) {
                ...
                if (axis == HORIZONTAL) {
                    info.horizontalSpring = this;
                } else {
                    info.verticalSpring = this;
                }
            }
        }
    }
     ...
     */
    public class PaddingSpring extends Spring {
    ...
    private class AutopaddingSpring extends Spring {
        ...
        public void calculatePadding(int axis) {
            ...
            if (matches != null) {
                ...
                // PENDING: rtl
                int position = (axis == HORIZONTAL) ? SwingConstants.EAST :
    ...
    private class ContainerAutopaddingSpring extends AutopaddingSpring {
        ...
        public void calculatePadding(int axis) {
            ...
            if (targets != null) {
                // Indicates leading
                // PENDING: rtl
                int position = (axis == HORIZONTAL) ? SwingConstants.WEST :
    ...
    private static class ComponentInfo {
        ...
        ComponentInfo(Component component) {
            this.component = component;
            visible = GroupLayout.isVisible(component);
            clear();
        }
        ...
        boolean updateVisibility() {
            boolean newVisible = GroupLayout.isVisible(component);
...
//                assert axis == VERTICAL;
        ...
        int getLinkSize(int axis, int type) {
            ...
            if (axis == HORIZONTAL) {
                if (horizontalMaster != this) {
                    return horizontalMaster.getLinkSize(axis, type);
                }
                sizes = horizontalSizes;
                dependants = horizontalDependants;
            } else if (axis == VERTICAL) {
                if (verticalMaster != this) {
                    return verticalMaster.getLinkSize(axis, type);
                }
                sizes = verticalSizes;
        ...
        private int calcLinkSize(List dependants, int axis, int type) {
            ...
            while (count >= 0) {
                size = Math.max(size, getDependantSpringSize(
                                    dependants, axis, type, count--));
            }
            return size;
        }
        
        private int getDependantSpringSize(List dependants, int axis,
                                           int type, int index) {
    ...
    //MODIFICATIONS:
    //getBaseline - exception caught
    //get/setContainer
    //made several inner classes public
    //edited getComponentInfo this (moved host.add up a line):
//    private ComponentInfo getComponentInfo(Component component) {
//        ComponentInfo info = (ComponentInfo)componentInfos.get(component);
//        if (info == null) {
//            host.add(component);
